...
const features = [
    {
      ...
      description: "AI analysis checks your form in real-time, ensuring correct posture for a safe and effective workout",
      icon: (
    ...
    },
    {
      ...
      description: "AI analysis helps you create personalized workout plans based on your fitness level and goals",
      icon: (
        <svg className="w-8 h-8 text-white" fill="none" viewBox="0 0 24 24" stroke="currentColor">
          <path
            strokeLinecap="round"
          ...
          >
            ...
            <div className="flex mt-3 space-x-3">
              <a href={member.linkedin} target="_blank" rel="noopener noreferrer">
                <Linkedin className="text-blue-600 w-5 h-5 hover:scale-110 transition" />
              </a>
              <a href={member.github} target="_blank" rel="noopener noreferrer">
                <Github className="text-gray-900 w-5 h-5 hover:scale-110 transition" />
              </a>
            </div>
          </motion.div>
        ))}
