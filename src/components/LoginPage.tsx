...
import img3 from "../assets/main-app-preview.png" // Use the same image or replace with a login-specific image
...
export default function Login() {
  ...
  return (
    <div className="height-[1400px] bg-gradient-to-br from-blue-50 to-pink-50 flex items-center justify-center">
      <div className="grid md:grid-cols-2 gap-2 w-full max-w-6xl bg-white rounded-2xl shadow-2xl overflow-hidden">
        ...
        >
          <div className="mb-4">
            ...
            <p className="text-gray-600">Log in to continue your fitness journey with BodyBuddy</p>
          </div>
